<template>
  <div class="box">
    ...
    <!-- <div id="know"></div> -->
    <v-chart ref="myChart" :option="op_chart" style="height: 400px">
    </v-chart>
...
<script>
  ...
  export default{
    ...
    mounted(){
      ...
      .then(res5=>{
          _this.nodelabels=res5.data.data;
      }).catch(err=>{
              ...
              _this.$axios.get("graph/node")
                .then(res3=>{
                  ...
                  for(let k=0;k<arr.length;k++){
                    ...
                    // _this.op_chart=chart(_this.datas,_this.linksdatas,_this.categorydatas);
                    // myChart.setOption(_this.op_chart);
